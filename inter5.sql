...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `inter`.`asignatura` ;
...
-- Table `inter`.`carrera`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `inter`.`carrera` ;
...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `inter`.`cuadernillo` ;
...
CREATE TABLE IF NOT EXISTS `inter`.`cuadernillo` (
  ...
  `numero_semana` INT(11) NULL DEFAULT NULL,
...
-- Table `inter`.`rol`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `inter`.`rol` ;
...
-- Table `inter`.`persona`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `inter`.`persona` ;
...
-- Table `inter`.`usuario`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `inter`.`usuario` ;
...
-- Table `inter`.`cuenta`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `inter`.`cuenta` ;
...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `inter`.`documentacion` ;
...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `inter`.`empleado` ;
...
-- Table `inter`.`empresa`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `inter`.`empresa` ;
...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `inter`.`estudiante` ;
...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `inter`.`pasantia` ;
...
-- Table `inter`.`entrega`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `inter`.`entrega` ;
...
-- Table `inter`.`estudia`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `inter`.`estudia` ;
...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `inter`.`funcionalidad` ;
...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `inter`.`privilegios` ;
...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `inter`.`requisitos` ;
...
-- Table `inter`.`union`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `inter`.`union` ;
...
-- Table `inter`.`tiene`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `inter`.`tiene` ;
