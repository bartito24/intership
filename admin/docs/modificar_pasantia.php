<?php
    ...
    $sql3="select * from estudiante join persona p on estudiante.persona_id_persona = p.id_persona where activoestudiante=1 and activo=1";
    $sql4="select * from empleado join persona p on empleado.persona_id_persona = p.id_persona where cargo='Tutor' || cargo='Jefe de Carrera' and activoempleado=1 and activo=1 and id_empleado=$id_empleado";
