        ...
        <div class="row">
            <div class="col-md-12">
                <div class="card">
                    ...
                    <div class="card-body">
                            <div class="form-group row"><label for="nombre" class="col-md-4 col-form-label text-md-right">Nombre:</label><div class="col-md-6"><input type="text" name="nombre" id="nombre" class="form-control" value="" required autofocus onkeypress="return sololetras(event);" maxlength="35"></div></div>
                            <div class="form-group row"><label for="papellido" class="col-md-4 col-form-label text-md-right" >Primer apellido:</label><div class="col-md-6"><input type="text" name="papellido" id="papellido" class="form-control" value="" required onkeypress="return sololetras(event);" maxlength="35"></div></div>
                            <div class="form-group row"><label for="sapellido" class="col-md-4 col-form-label text-md-right" >Segundo apellido:</label><div class="col-md-6"><input type="text" name="sapellido" id="sapellido" value="" class="form-control" onkeypress="return sololetras(event);" maxlength="35"></div></div>
