...
$pdf->SetX(130);
$pdf->Cell(60,10,"Pasantia",0,0,"C" ,true);
$pdf->SetX(180);
$pdf->Cell(60,10,"Regimen",0,0,"C" ,true);
$pdf->SetX(220);
$pdf->Cell(60,10,"Empresa",0,1,"C" ,true);
...
$sql="select * from pasantia join estudiante e on pasantia.estudiante_id_estudiante = e.id_estudiante join persona p on e.persona_id_persona = p.id_persona
  ...
  join carrera c on e3.carrera_id_carrera = c.id_carrera where empleado_id_empleado=$tutor";
