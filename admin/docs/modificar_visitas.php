...
$datos_visita=$ob->con_retorno($sql);
while ($row=mysqli_fetch_assoc($datos_visita))
{
    $observaciones=$row['observacionvisita'];
}
?>
                    ...
                    <form action="../../enrutador/enr_visita.php" method="post">
                        <div class="card-body">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-4"><textarea class="form-control" name="observaciones" id="observaciones" rows="3"><?php echo $observaciones?></textarea></div>
                            </div>
                        ...
                        <div class="card-footer">
                            <div class="form-group row">
                                <div class="col-md-2">
                                    <button class="btn btn-outline-primary" name="modificar" type="submit">Actualizar</button>
                                </div>
                                <div class="col-md-2">
                                    <button class="btn btn-dark" name="limpiar" type="reset">Limpiar</button>
                                </div>
                                <div class ="col-md-2"><a class="btn btn-danger" href="listar_pasantia.php">Cancelar
                                    </a>
                                </div>
                            </div>
                        </div>
