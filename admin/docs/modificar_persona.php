...
<main class="app-content">
    ...
    <div class="row">
        <div class="col-md-7">
            <div class="tile">
                <div class="tile-title">Modificación de Persona</div>
                <div class="tile-body">
                    <form action="../../enrutador/enr_agregarusuario.php" method="post" autocomplete="off" required>
                        <div class="form-group row">
                            ...
                            <div class="col-md-5"><input class="form-control" type="text" name="nombre" id="nombre" value="<?php echo $_GET['nombre'];?>"></div>

                        </div>

                        <div class="form-group row">
                            <div class="col-md-4"><label class="col-form-label text-md-right" for="papellido">Apellido Paterno:</label></div>
                            <div class="col-md-5"><input class="form-control" type="text" name="papellido" id="papellido" value="<?php echo $_GET['papellido'];?>"></div>

                        </div>

                        <div class="form-group row">
                            <div class="col-md-4"><label class="col-form-label text-md-right" for="sapellido">Apellido Materno:</label></div>
                            <div class="col-md-5"><input class="form-control" type="text" name="sapellido" id="sapellido" value="<?php echo $_GET['sapellido'];?>"></div>

                        </div>

                        <div class="form-group row">
                            <div class="col-md-4"><label class="col-form-label text-md-right" for="ci">C.I:</label></div>
                            <div class="col-md-5"><input class="form-control" type="text" name="ci" id="ci" value="<?php echo $_GET['ci'];?>"></div>

                        </div>

                        <div class="form-group row">
                            <div class="col-md-4"><label class="col-form-label text-md-right" for="telefono">Telefono:</label></div>
                            <div class="col-md-5"><input class="form-control" type="text" name="telefono" id="telefono" value="<?php echo $_GET['telefono'];?>"></div>

                        </div>

                        <div class="form-group row">
                            <div class="col-md-4"><label class="col-form-label text-md-right" for="direccion">Dirección:</label></div>
                            <div class="col-md-5"><input class="form-control" type="text" name="direccion" id="direccion" value="<?php echo $_GET['direccion'];?>"></div>

                        </div>

                        <div class="form-group row">
                            <div class="col-md-4"><label class="col-form-label text-md-right" for="email">Email:</label></div>
                            <div class="col-md-5"><input class="form-control" type="text" name="email" id="email" value="<?php echo $_GET['email'];?>"></div>
                        </div>
