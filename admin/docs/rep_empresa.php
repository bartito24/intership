...
$pdf->SetFillColor(200,71,71);
$pdf->SetX(10);
$pdf->Cell(27,10,"Estudiante",0,0,"C",true);
$pdf->SetX(35);
$pdf->Cell(27,10,"fechainicio",0,0,"C" ,true);
$pdf->SetX(60);
$pdf->Cell(27,10,"area",0,0,"C" ,true);
$pdf->SetX(85);
$pdf->Cell(27,10,"latitud_em",0,0,"C" ,true);
$pdf->SetX(110);
$pdf->Cell(27,10,"longitud_em",0,1,"C" ,true);
$pdf->SetX(135);
...
while ($row=mysqli_fetch_assoc($resultado)){
    ...
    $pdf->Cell(27,10,$nombre,0,0,"C",true);
    $pdf->SetX(35);
    $pdf->Cell(27,10,$fechainicio,0,0,"C" ,true);
     $pdf->SetX(60);
     $pdf->Cell(27,10,$area,0,0,"C" ,true);
     $pdf->SetX(85);
     $pdf->Cell(27,10,$latitud_empresa,0,0,"C" ,true);
     $pdf->SetX(110);
     $pdf->Cell(27,10,$longitud_empresa,0,0,"C" ,true);
     $pdf->SetX(135);
