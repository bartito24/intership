...
class mdl_pasantia
{
    ...
    {
        $sql = "SELECT * FROM pasantia join empleado e3 on pasantia.empleado_id_empleado = e3.id_empleado join estudiante e on pasantia.estudiante_id_estudiante = e.id_estudiante join persona p on e.persona_id_persona = p.id_persona
